...
module.exports = exports = nano = function database_module(cfg) {
                    ...
                    if (key in params) {
                        try {
                            ...
                            return errs.handle(errs.merge(err,
                                { "message":"bad params: " + key + " = " + params[key], "scope":"nano", "errid":"encode_keys"
                                }), callback);
                        }
                    }
                });
    ...
    function document_module(db_name) {
        ...
        function insert_att(doc_name, att_name, att, content_type, params, callback) {
            ...
            return relax(
                { db:db_name, att:att_name, method:"PUT", content_type:content_type, doc:doc_name, params:params, body:att}, callback);
        }
        ...
        function get_att(doc_name, att_name, params, callback) {
            ...
            return relax({ db:db_name, att:att_name, method:"GET", doc:doc_name, params:params, encoding:null}, callback);
        }
        ...
        { info:function (cb) {
            ...
            , insert:insert_doc, get:get_doc, head:head_doc, copy:copy_doc, destroy:destroy_doc, bulk:bulk_docs, list:list_docs, fetch:fetch_docs, config:{url:cfg.url, db:db_name}, attachment:{ insert:insert_att, get:get_att, destroy:destroy_att
