...
vows.describe('cradle/connection').addBatch({
    "Default connection settings":{
        ...
        "with a host and port passed to Connection":{
            topic:function () {
                return new (cradle.Connection)("255.255.0.0", 9696)
            },
            "should override the defaults":function (c) {
        ...
        "with a host, port and options passed to Connection":{
            topic:function () {
                return new (cradle.Connection)("4.4.4.4", 911, {raw:true})
            },
            "should override the defaults":function (c) {
        ...
        "with a host and port and protocol passed to Connection":{
            topic:function () {
                return new (cradle.Connection)("http://4.4.4.4", 911, {raw:true, secure:true})
            },
            "should override the defaults":function (c) {
                assert.equal(c.host, '4.4.4.4');
                assert.equal(c.port, 911);
        ...
        "with a host and port passed as an object to Connection":{
            topic:function () {
                return new (cradle.Connection)({ host:"https://4.4.4.4", port:911, raw:true })
            },
            "should override the defaults":function (c) {
                assert.equal(c.options.secure, true);
                assert.equal(c.host, '4.4.4.4');
        ...
        "with a the 'https' protocol":{
            topic:function () {
                return new (cradle.Connection)("https://couch.io", 5984)
            },
        ...
        "with the port as part of the URL":{
            topic:function () {
                return new (cradle.Connection)("https://couch.io:418")
            },
        ...
        "Connection":{
            ...
            "create()":{
                "with no / in the name":{
                    ...
                    "creates a database":{
                        topic:function (res, c) {
                            c.database('badgers').exists(this.callback)
                        },
                        "it exists":function (res) {
                            assert.ok(res)
                        }
                    }
                },
                "with a / in the name":{
                    ...
                    "creates a database":{
                        topic:function (res, c) {
                            c.database('madeup/ewoks').exists(this.callback)
                        },
                        "it exists":function (res) {
                            assert.ok(res)
                        }
            ...
            "destroy()":{
                ...
                "destroys a database":{
                    ...
                    "it doesn't exist anymore":function (res) {
                        assert.ok(!res)
                    }
                }
            }
